...
class BiharScreen extends StatefulWidget {

  @override
  _BiharScreenState createState() => _BiharScreenState();
}

class _BiharScreenState extends State<BiharScreen> {
  String name = "";
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: (name != "" && name != null)
                    ...
                    .snapshots()
                    : FirebaseFirestore.instance
                    .collection("patna").orderBy("name",descending: false)
                    .snapshots(),
