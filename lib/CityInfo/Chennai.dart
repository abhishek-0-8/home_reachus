...
class ChennaiScreen extends StatefulWidget {

  @override
  _ChennaiScreenState createState() => _ChennaiScreenState();
}

class _ChennaiScreenState extends State<ChennaiScreen> {
  String name = "";
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: (name != "" && name != null)
                    ...
                    .snapshots()
                    : FirebaseFirestore.instance
                    .collection("chennai").orderBy("name",descending: false)
                    .snapshots(),
