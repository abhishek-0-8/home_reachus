        ...
        body: Container(
          ...
          child:
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: kDefaultPadding),
              child: Text(
                  'Delhi has the highest numbers of Non '
                  'Governmental Organisations (NGOs) '
                  'registered in India and are '
                  'constantly working for social welfare, development issues and programmes. ',
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: (name != "" && name != null)
                        ...
                        .snapshots()
                        : FirebaseFirestore.instance
                        .collection("delhi").orderBy("name",descending: false)
                        .snapshots(),
