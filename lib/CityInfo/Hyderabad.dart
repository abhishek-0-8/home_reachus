...
class HyderabadScreen extends StatefulWidget {
  @override
  _HyderabadScreenState createState() => _HyderabadScreenState();
}

class _HyderabadScreenState extends State<HyderabadScreen> {
  String name = "";
